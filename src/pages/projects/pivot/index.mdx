...
<YouTube id="9bxkNTe0DMw" />

_Pivot was presented at [Ivyhacks 2020, where it won Best Multiplayer Product](https://devpost.com/software/pivot-9ytkdq)._
...
<Picture src={import('./1.png')} alt="Screenshot 1" widths={[400, 800, 1200]} />

<Picture src={import('./2.png')} alt="Screenshot 2" widths={[400, 800, 1200]} />

<Picture src={import('./3.png')} alt="Screenshot 3" widths={[400, 800, 1200]} />

<Picture src={import('./4.png')} alt="Screenshot 4" widths={[400, 800, 1200]} />

<Picture src={import('./5.png')} alt="Screenshot 5" widths={[400, 800, 1200]} />
