...
<Image src={import('./1.jpg')} alt="Screenshot 1" />

<Image src={import('./2.jpg')} alt="Screenshot 2" />

<Image src={import('./3.jpg')} alt="Screenshot 3" />

<Image src={import('./4.jpg')} alt="Screenshot 4" />

<Image src={import('./5.jpg')} alt="Screenshot 5" />

<Image src={import('./6.jpg')} alt="Screenshot 6" />

<Image src={import('./7.jpg')} alt="Screenshot 7" />
